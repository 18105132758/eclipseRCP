...
public class Factory {
    public static List<ITree> createTree(){
        //生成国家
        ...
        //关联城市与国家
        //中国
        ArrayList<ITree> citys = new ArrayList<ITree>();
        citys.add(beijing);
        citys.add(shanghai);
        cn.setChildren(citys);
        //美国
        citys = new ArrayList<ITree>();
        citys.add(newyork);
        citys.add(la);
        ...
        //国家列表
        ArrayList<ITree> countrys = new ArrayList<ITree>();
        countrys.add(cn);
        countrys.add(us);
        countrys.add(jp);
        return countrys;
